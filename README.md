...
### 2026/1/21
- 添加氧气消耗系统（每秒扣1点生命值），创建 `OxygenSystem.js` 模块
- UI 文本调整：生命值→氧气、经验→充能进度、技能点→能源、等级显示改为 Lv.x
- 宝箱功能重构：从"获取新武器"改为"武器进化"（两个基础武器合成高级武器）
- 新增 `ChestManager.executeFusion()` 和 `WeaponSystem.setWeapons()` 方法
