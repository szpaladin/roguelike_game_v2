...
| 细胞 (cell) | 冰霜 (frost) | 冰屑群 (ice_shard_swarm) | 建议 | 由细胞与冰霜融合而成，效果：分裂子弹 + 冻结 |
| 细胞 (cell) | 幽灵 (ghost) | 幽群 (wraith_swarm) | 建议 | 由细胞与幽灵融合而成，效果：分裂子弹 + 穿透 |
| 细胞 (cell) | 光芒 (light) | 棱光群 (prism_swarm) | 建议 | 由细胞与光芒融合而成，效果：致盲 + 分裂子弹 |
| 细胞 (cell) | 闪电 (lightning) | 电孢群 (spark_spore_swarm) | 建议 | 由细胞与闪电融合而成，效果：连锁闪电 + 分裂子弹 |
| 细胞 (cell) | 剧毒 (poison) | 毒孢群 (toxic_spore_swarm) | 建议 | 由细胞与剧毒融合而成，效果：中毒DOT + 分裂子弹 |
| 细胞 (cell) | 射线 (ray) | 辐射射线 (radiation_beam) | 建议 | 由细胞与射线融合而成，效果：射线AOE + 辐射易伤 |
...
| 黑暗 (dark) | 剧毒 (poison) | 疫咒 (plague_curse) | 建议 | 由黑暗与剧毒融合而成，效果：中毒DOT + 易伤 |
...
| 冰霜 (frost) | 火焰 (fire) | 燃霜进化 (frostfire) | 现有 | 冰霜与火焰的矛盾融合为燃霜 |
| 冰霜 (frost) | 幽灵 (ghost) | 霜灵 (frost_wraith) | 建议 | 由冰霜与幽灵融合而成，效果：穿透 + 冻结 |
| 冰霜 (frost) | 光芒 (light) | 白晕 (white_halo) | 建议 | 由冰霜与光芒融合而成，效果：冻结 + 致盲 |
...
| 冰霜 (frost) | 钢铁 (steel) | 破冰锤 (icebreaker_hammer) | 建议 | 由冰霜与钢铁融合而成，效果：冻结 + 高伤 |
...
| 幽灵 (ghost) | 剧毒 (poison) | 毒灵 (toxic_wraith) | 建议 | 由幽灵与剧毒融合而成，效果：中毒DOT + 穿透 |
| 幽灵 (ghost) | 射线 (ray) | 辐射射线 (radiation_beam) | 建议 | 由幽灵与射线融合而成，效果：射线AOE + 辐射易伤 |
...
| 剧毒 (poison) | 射线 (ray) | 辐射射线 (radiation_beam) | 建议 | 由剧毒与射线融合而成，效果：射线AOE + 辐射易伤 |
| 剧毒 (poison) | 岩石 (rock) | 毒爆 (toxic_burst) | 建议 | 由剧毒与岩石融合而成，效果：中毒DOT + 圆形AOE |
| 剧毒 (poison) | 钢铁 (steel) | 毒钉 (toxic_spike) | 建议 | 由剧毒与钢铁融合而成，效果：高伤 + 中毒DOT |
| 剧毒 (poison) | 吸血 (vampire) | 吸毒 (leech_toxin) | 建议 | 由剧毒与吸血融合而成，效果：中毒DOT + 吸血 |
...
| 钢铁 (steel) | 火焰 (fire) | 炸弹进化 (bomb) | 现有 | 钢铁的威力与火焰的爆炸融合为炸弹 |
| 钢铁 (steel) | 疾风 (swift) | 疾枪 (rapid_lance) | 建议 | 由钢铁与疾风融合而成，效果：穿透 + 高伤 |
| 钢铁 (steel) | 吸血 (vampire) | 血槌 (blood_hammer) | 建议 | 由钢铁与吸血融合而成，效果：高伤 + 吸血 |
| 疾风 (swift) | 火焰 (fire) | 炼狱进化 (inferno) | 现有 | 疾风的穿透与火焰的灼烧融合为炼狱 |
| 疾风 (swift) | 冰霜 (frost) | 暴风雪进化 (blizzard) | 现有 | 疾风的速度与冰霜的寒冷融合为暴风雪 |
| 疾风 (swift) | 闪电 (lightning) | 风暴进化 (storm) | 现有 | 疾风的穿透与闪电的连锁融合为风暴 |
| 疾风 (swift) | 剧毒 (poison) | 毒雾进化 (poison_mist) | 现有 | 疾风的穿透与剧毒的毒素融合为毒雾 |
| 疾风 (swift) | 吸血 (vampire) | 迅吸 (swift_leech) | 建议 | 由疾风与吸血融合而成，效果：穿透 + 吸血 |
